...
public class AppSecurityConfig {
	 ...
	 * oidcUser = delegate.loadUser(userRequest); System.out.println("OICD User: " +
	 * oidcUser);
	 * 
	 ...
	 * OidcUser oidcUserNew = new DefaultOidcUser(mappedAuthorities, accessToken,
	 * oidcUser.getName() );
	 * 
	 * return oidcUserNew; } catch (Exception e) { e.printStackTrace(); throw e; }
	 * 
	 * }; }
	 */
}
